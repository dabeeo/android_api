...
class DrawObjectsEventActivity : AppCompatActivity() {
    ...
    private val mPolygonEvent = object : DrawEvent<Polygon>() {
        override fun click(drawObject: Polygon?) {
            toastMessage("You removed Polygon.\n${drawObject?.id}")
            drawObject?.apply {
                event = null
                remove()
            }
    ...
    private val mPolylineEvent = object : DrawEvent<Polyline>() {
        override fun click(drawObject: Polyline?) {
            toastMessage("You removed Polyline.\n${drawObject?.id}")
            drawObject?.apply {
                event = null
                remove()
            }
    ...
    private val mCircleEvent = object : DrawEvent<Circle>() {
        override fun click(drawObject: Circle?) {
            toastMessage("You removed Circle.\n${drawObject?.id}")
            drawObject?.apply {
                event = null
                remove()
            }
    ...
    private val mMarkerEvent = object : DrawEvent<Marker>() {
        override fun click(drawObject: Marker?) {
            toastMessage("You removed Marker.\n${drawObject?.id}")
            drawObject?.apply {
                event = null
                remove()
            }
    ...
    private fun addPolygon() {
        ...
        Polygon(
            ...
            polygonOptions,
            mMapView
        ).apply { event = mPolygonEvent }.addTo()
    }
    ...
    private fun addPolyline() {
        ...
        Polyline(
            ...
            polylineOptions,
            mMapView
        ).apply { event = mPolylineEvent }.addTo()
    }
    ...
    private fun addCircle() {
        ...
        Circle(
            ...
            circleOptions,
            mMapView
        ).apply { event = mCircleEvent }.addTo()
    }
    ...
    private fun addMarker() {
        ...
        Marker(
            ...
            markerOptions,
            mMapView
        ).apply { event = mMarkerEvent }.addTo()
    }
